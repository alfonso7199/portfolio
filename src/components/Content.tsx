        ...
        <div className="space-y-3 md:space-y-4 lg:space-y-5 mt-4 md:mt-6 max-h-[50vh] lg:max-h-[60vh] overflow-y-auto pr-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          <div>
            <a
              ...
              className="text-lg md:text-2xl lg:text-3xl font-semibold text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-400 transition-colors"
            >
              Creatine Tracker
            </a>
            <p className="text-sm md:text-base lg:text-base text-gray-700 dark:text-gray-300 mt-1 md:mt-2 font-pp_neue_montrealbold font-semibold dark:font-normal">
          ...
          <div>
            ...
            <p className="text-sm md:text-base lg:text-base text-gray-700 dark:text-gray-300 mt-1 md:mt-2 font-pp_neue_montrealbold font-semibold dark:font-normal">
              A competitive coding platform where developers challenge each other in real-time programming duels, available on Google Play Store.
            </p>
          </div>
          <div>
            <a
            ...
            <p className="text-sm md:text-base lg:text-base text-gray-700 dark:text-gray-300 mt-1 md:mt-2 font-pp_neue_montrealbold font-semibold dark:font-normal">
              A web-based tool for sprite sheet generation and manipulation, designed for game developers and digital artists.
            </p>
          </div>
          <div>
            <a
          ...
          <div>
            ...
            <p className="text-sm md:text-base lg:text-base text-gray-700 dark:text-gray-300 mt-1 md:mt-2 font-pp_neue_montrealbold font-semibold dark:font-normal">
              A raycasting-based 3D game engine inspired by Wolfenstein 3D, developed in C as part of the 42 curriculum.
            </p>
          </div>
          <div>
            <a
